...
namespace Mathlife.ProjectL.Gameplay
{
    ...
    public class CharacterRosterState : IState
    {
        ...
        void LoadFromStarterData()
        {
            ...
            List<VehiclePreset> starterCharacters = new();
            ...
            {
                if (starterCharacter.vehicle == null)
                    continue;
                ...
                CharacterModel model = new(starterCharacter.vehicle, expData, level, totalExp);
                ...
                m_characters.Add(starterCharacter.vehicle.id, model);
            }

            List<CharacterModel> teamMembers = new();
            foreach (var starterMember in starterParty)
            {
                if (starterMember.vehicle == null)
                {
                    teamMembers.Add(null);
                    continue;
                }

                int id = starterMember.vehicle.id;
